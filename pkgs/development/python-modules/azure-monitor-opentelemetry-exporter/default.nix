...
buildPythonPackage rec {
  pname = "azure-monitor-opentelemety-exporter";
  version = "1.0.0b41";
  ...
  meta = {
    ...
    description = "he exporter for Azure Monitor allows Python applications to export data from the OpenTelemetry SDK to Azure Monitor";
